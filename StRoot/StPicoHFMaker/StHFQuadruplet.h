...
inline TLorentzVector const & StHFQuadruplet::lorentzVector() const { return mLorentzVector;}
...
inline TVector3 const & StHFQuadruplet::decayVertex() const { return mDecayVertex;}
