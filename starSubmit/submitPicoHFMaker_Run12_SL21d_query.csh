...
set starProduction=P12id

set triggerSetup=pp200_production_2012
...
# -- set root macro
set rootMacro=runPicoLambdaAnaMaker.C
...
# -- submission xml file 
set xmlFile=submitPicoHFMaker_query.xml
...
echo '<\!ENTITY starProd "'${starProduction}'">'                     >> $hackTemplate
echo '<\!ENTITY trigSetup "'${triggerSetup}'">'                     >> $hackTemplate
echo '<\!ENTITY noFiles "'${numberOfFiles}'">'                     >> $hackTemplate
